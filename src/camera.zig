...
pub fn getCameraDriver(index: c_int) ![]const u8 {
    return std.mem.span(try errify(c.SDL_GetCameraDriver(index)));
}

/// Get the name of the current camera driver.
pub fn getCurrentCameraDriver() ![]const u8 {
...
pub fn getCameraName(instance_id: CameraID) ![]const u8 {
...
pub const Camera = struct {
    ...
    pub fn open(instance_id: CameraID, spec: CameraSpec) !Camera {
        return Camera{
    ...
    pub fn getFormat(self: *const Camera) !CameraSpec {
